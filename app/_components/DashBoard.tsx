            ...
            <div className='grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4'>
                        ...
                        <div className='flex gap-3 py-2'>
                            <div className="relative size-20 md:size-32">
                                <svg className="rotate-[135deg] size-full" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="18" cy="18" r="16" fill="none" className="stroke-current text-gray-200 dark:text-neutral-700" stroke-width="3" stroke-dasharray="75 100" stroke-linecap="round"></circle>

                                    <circle cx="18" cy="18" r="16" fill="none" className="stroke-current text-blue-600 dark:text-blue-500" stroke-width="3" stroke-dasharray="37.5 100" stroke-linecap="round"></circle>
                                </svg>
                                ...
                                <div className="absolute top-2/3 start-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
                                    ...
                                    <span className="block pt-2">ปกติ</span>
                                </div>
                            </div>
                            ...
                            <div className='grid grid-cols-2 items-end md:items-center'>
                                <div className='flex flex-col'>
                                    ...
                                    <span className='text-xl md:text-header font-semibold'>70.00 <span className='text-base md:text-unit font-thin'>กก.</span></span>
                                </div>
                                <div className='flex flex-col'>
                                    <span className='text-xl md:text-sub'>ส่วนสูง</span>
                                    <span className='text-xl md:text-header font-semibold'>170.00 <span className='text-base md:text-unit font-thin'>กก.</span></span>
                                </div>
                            </div>
                        </div>
                    </WrapCard>
                ...
                <WrapSub IconName={blood_pressure.src} HeaderName={'ความดันโลหิต'} date={date}>
                    <div className={'flex flex-row'}>
                        <span><h5 className={'text-xl md:text-header font-semibold'}>00 <span className={'text-base md:text-unit font-light'}>mm/Hg</span></h5></span>
                    </div>
                </WrapSub>
                <WrapSub IconName={oxigen_in_blood.src} HeaderName={'ระดับออกซิเจนในเลือด'} date={date}>
                    <div className={'flex flex-row'}>
                        <span><h5 className={'text-xl md:text-header font-semibold'}>00 <span className={'text-base md:text-unit font-light'}>%</span></h5></span>
                    </div>  
                </WrapSub>
                <WrapSub IconName={heart_rate.src} HeaderName={'อัตราการเต้นหัวใจ'} date={date}>
                    <div className={'flex flex-row'}>
                        <span><h5 className={'text-xl md:text-header font-semibold'}>-- <span className={'text-base md:text-unit font-light'}>bpm</span></h5></span>
                    </div>
                </WrapSub>
                <WrapSub IconName={temperature.src} HeaderName={'อุณหภูมิร่างกาย'} date={date}>
                    <div className={'flex flex-row'}>
                        <span><h5 className={'text-xl md:text-header font-semibold'}>00 <span className={'text-base md:text-unit font-light'}>ºC</span></h5></span>
                    </div>
                </WrapSub>
                <WrapSub IconName={blood_group.src} HeaderName={'หมู่เลือด'} date={date}>
                    <div className={'flex flex-row'}>
                        <span><h5 className={'text-xl md:text-header font-semibold'}>AB<span className={'text-base md:text-unit font-light'}></span></h5></span>
                    </div >       
                </WrapSub>
                <WrapSub IconName={blood_sugar.src} HeaderName={'ระดับน้ำตาลในเลือด'} date={date}>
                    <div className={'flex flex-row'}>
                        <span><h5 className={'text-xl md:text-header font-semibold'}>00 <span className={'text-base md:text-unit font-light'}>มม./ดล.</span></h5></span>
                    </div>
                </WrapSub>
                        ...
                        <div className='grid grid-cols-4 py-2'>
                            {[
                                ...
                                <div key={i} className='flex flex-col'>
                                    <div className='text-center text-base md:text-unit font-thin'>{name}</div>
                                    <div className='text-center text-xl md:text-header font-semibold'>{num}</div>
                                    <div className='text-center text-base md:text-unit font-thin'>{unit}</div>
                                </div>
                            ))}
                        </div>
                    </WrapCard>
        ...
        <div className='rounded-lg w-full shadow-md shadow-[#C4DAFF80] p-4'>
            <div className='flex justify-between items-center'>
                <div className='flex gap-1 items-center'>
                    ...
                    <span className='text-base md:text-unit font-thin'>{date}</span>
                </div>
                <div>
    ...
    return(
        <div className='rounded-lg w-full shadow-md shadow-[#C4DAFF80] p-4'>
            <div className='flex flex-col justify-between h-full'>
                ...
                <div>
                    <p className='pt-2 text-sm md:text-unit font-thin'>{date}</p>
                </div>
            </div>
        </div>
    );
